...
editor: visual
---
# Ravelry Popularity Exploration Code

## GitHub link: https://github.com/sarahglidden97/SURV-727-Final-Project

## Load packages and data pull code
...
## Clean remaining data sets using function and combine
...
## Create data frame for regression analysis and data frame for Shiny app
Note: Shiny app code is available in app.R file on Github.
Code chunk here is set to eval=FALSE.
